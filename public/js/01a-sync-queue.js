...
function _pendingBadge(){
  try{
    ...
    if(!b){
      ...
      b.style.cssText='position:fixed;bottom:14px;left:14px;z-index:99;background:#F5EFDF;color:#463830;border:1.5px solid #F5DCC0;border-radius:10px;padding:6px 12px;font-size:12px;font-weight:700;box-shadow:0 4px 14px rgba(0,0,0,.10);cursor:pointer';
