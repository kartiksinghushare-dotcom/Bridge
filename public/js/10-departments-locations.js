...
function deptsPage(){
  ...
  if(sel){
    ...
    return'<div class="fade">'
      ...
      +TABS.map(([k,l])=>'<button onclick="App._setDeptTab(this.dataset.k)" data-k="'+k+'" style="flex:1;padding:8px;border-radius:9px;font-size:13px;font-weight:700;border:none;cursor:pointer;background:'+(stab===k?'#fff':'transparent')+';color:'+(stab===k?'#13171B':'#6B7280')+';box-shadow:'+(stab===k?'0 1px 4px rgba(0,0,0,.08)':'none')+'">'+l+'</button>').join('')
      +'</div>'
      // Tab content
...
function locsPage(){
  ...
  if(sel){
    ...
    return'<div class="fade">'
      ...
      +'</div>'
      +'<div style="display:flex;gap:4px;margin-bottom:16px;background:#F6F7F8;border-radius:12px;padding:4px">'
      +TABS.map(([k,ll])=>'<button onclick="App._setLocTab(this.dataset.k)" data-k="'+k+'" style="flex:1;padding:8px;border-radius:9px;font-size:13px;font-weight:700;border:none;cursor:pointer;background:'+(stab===k?'#fff':'transparent')+';color:'+(stab===k?'#13171B':'#6B7280')+';box-shadow:'+(stab===k?'0 1px 4px rgba(0,0,0,.08)':'none')+'">'+ll+'</button>').join('')
      +'</div>'
